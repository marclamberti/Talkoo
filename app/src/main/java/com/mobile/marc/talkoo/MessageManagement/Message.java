...
//    private boolean is_mine_;
    ...
    public String getGroupName() { return group_name_; }
    public void setGroupName(String group_name) { this.group_name_ = group_name; }
...
//    public boolean isMine() { return is_mine_; }
//    public void setMine(boolean isMine) { this.is_mine_ = isMine; }
